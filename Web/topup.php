                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>Here you can top up your Account</h4>
                                    </div>           
                                </div>
                            </div>
							<!-- CONTENT HERE -->
                            <div class="widget-content widget-content-area">
                                <iframe src="https://api.paymentwall.com/api/ps/?key=6538585ef4f45de9a6c995c69c2fff45&uid=<?php echo $userID; ?>&widget=p1_1" width="100%" height="850px" frameborder="0"></iframe>            
							</div>
                        </div>
                    </div>
                </div>
